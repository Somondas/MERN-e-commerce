...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetails, createProductReview, getProductReviews, deleteReview, getProductDetailsByKeyword } = require("../controller/productController")
...
router.route("/products/:keyword").get(getProductDetailsByKeyword)
